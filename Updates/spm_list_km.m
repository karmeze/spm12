...
%==========================================================================
   ...
   %KKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK
    ...
    h  = line([0,0.10],[1,1]*(y-dy/4),'LineWidth',0.5,'Color','r'); Hs = [Hs,h];
    h  = text(0.02,y-9*dy/8,    TabDat.hdr{3,1});              Hs = [Hs,h];
    h  = text(0.07,y-9*dy/8,    TabDat.hdr{3,2});              Hs = [Hs,h];
    
    h = text(0.17,y, [TabDat.hdr{1,3} '-level'],'FontSize',FS(8));    Hc = [Hc,h];
    h = line([0.12,0.38],[1,1]*(y-dy/4),'LineWidth',0.5,'Color','r'); Hc = [Hc,h];
    h  = text(0.11,y-9*dy/8,    TabDat.hdr{3,3});              Hc = [Hc,h];
    h  = text(0.19,y-9*dy/8,    TabDat.hdr{3,4});              Hc = [Hc,h];
    h  = text(0.27,y-9*dy/8,    TabDat.hdr{3,5});              Hc = [Hc,h];
    h  = text(0.31,y-9*dy/8,    TabDat.hdr{3,6});              Hc = [Hc,h];
    
    h = text(0.52,y, [TabDat.hdr{1,7} '-level'],'FontSize',FS(8));    Hp = [Hp,h];
    h = line([0.40,0.72],[1,1]*(y-dy/4),'LineWidth',0.5,'Color','r'); Hp = [Hp,h];
    h  = text(0.395,y-9*dy/8,    TabDat.hdr{3,7});              Hp = [Hp,h];
    h  = text(0.465,y-9*dy/8,    TabDat.hdr{3,8});              Hp = [Hp,h];
    h  = text(0.55,y-9*dy/8,    TabDat.hdr{3,9});              Hp = [Hp,h];
    h  = text(0.60,y-9*dy/8,    TabDat.hdr{3,10});             Hp = [Hp,h];
    h  = text(0.66,y-9*dy/8,    TabDat.hdr{3,11});             Hp = [Hp,h];
    
    text(0.73,y - dy/2,TabDat.hdr{3,12},'Fontsize',FS(8));
  
    text(0.88,y - dy/2,TabDat.hdr{3,13},'Fontsize',FS(8));
    ...
    %----------------------------------------------------------------------
    tCol = [ 0.01      0.07 ...                                %-Set
             0.11      0.18      0.25      0.305 ...            %-Cluster
             0.39      0.46      0.51      0.58      0.65 ...  %-Peak
             0.72...                                           %-XYZ
             0.855];                                            %-Section
   %MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM 
