...
%==========================================================================
    ...
    if isempty(hMIPax)
       %CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
        ...
        %hMIPax = axes('Position',[0.05 0.79 0.55 0.56],'Parent',F);     % Qiang Chen
        %QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ
    else
    ...
    %-Print coordinates
    %----------------------------------------------------------------------
    hMIPxyz = text(6,max(get(hMIPax,'YLim'))/2,...
    ...
    text(220,250,'Talairach Space:',...
    'HorizontalAlignment','left',...
    'Fontweight','Bold');
    
    tspace.des{1} = text(230,265,'','Fontsize',10,...
    'HorizontalAlignment','left');
    tspace.des{2} = text(230,280,'','Fontsize',10,...
    'HorizontalAlignment','left');
    tspace.des{3} = text(230,295,'','Fontsize',10,...
    'HorizontalAlignment','left');
    tspace.des{4} = text(230,310,'','Fontsize',10,...
    'HorizontalAlignment','left');
    tspace.des{5} = text(230,325,'','Fontsize',10,...
    'HorizontalAlignment','left');
    ...
    %======================================================================
       ...
       %CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
        ...
        [des] = gcap_displayMni(posmm, voxsize);
        cc = 1;
        for c=1:length(des)
            set(tspace.des{cc}, 'String',des{c});
            cc = cc+1;
        end;
        end
